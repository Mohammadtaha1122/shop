    ...
    <div className="bg-white/50 py-4 shadow-sm fixed top-0 left-0 right-0 ">
      <header className="container flex justify-between items-center ">
        ...
        <div className="flex items-center gap-5 ">
          <button className="py-2.5 px-10 bg-[#1c2575] cursor-pointer rounded-lg text-lg text-white">ایجاد غرفه</button>
          <div className=" flex items-center gap-2 text-[#1c2575] cursor-pointer text-lg">
